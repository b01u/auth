  ...
  <div class="auth-container">
    ...
    <div class="components-container">
      <auth-edit :show.sync="editForm.show" :title="editForm.title" :modlist="modList"
                 :mode="editForm.mode" @confirm="authEditConfirm"
      ></auth-edit>
    </div>
        ...
        <div class="ks-row-auto spacing-20-0">
          ...
          <div class="ks-col-auto">
            <ks-page :page_current.sync="pager.currentPage" :total="pager.total"
              :page_size="pager.pageSize" @current_change="getAuthList"></ks-page>
          </div>
        </div>
      </div>
    </div>
  ...
  export default{
    ...
    methods: {
      ...
      addAuth () {
        ...
        editForm.mode = 'add'
        // 初始化编辑框中权限数据
        this.$broadcast('authEditInit', {module_id: this.searchForm.moduleId})
        // 打开编辑权限弹出框
        editForm.show = true
      },
